var SiteHelper = {
    ...
    init: function () {
        var $this = this;
        $this._map();
        $this.map.expandLink.click(function () {
            return $this.expandLinkClick(this);
        });
        $this.map.actionLink.click(function () {
            return $this.actionLinkClick(this);
        });
        $this.map.actionAllLink.click(function () {
            return $this.actionAllLinkClick(this);
        });
        $this.map.pageSize.change(function () {
            return $this.pageSizeChange(this);
        });
        $this.map.recordName.change(function () {
        ...
        $this.tabContentLoad();
        $this.map.form.on('afterValidate', function () {
            $this.tabContentLoad();
        });

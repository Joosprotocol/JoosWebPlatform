var RoleHelper = {
    ...
    init: function () {
        var $this = this;
        $this._map();
        $this.map.typeCheckbox.change(function () {
            return $this.typeCheckboxChange(this);
        });
        $this.map.moduleCheckbox.change(function () {
            return $this.moduleCheckboxChange(this);
        });
        $this.map.readCheckbox.change(function () {
            return $this.readCheckboxChange(this);
        });
        $this.map.allCheckbox.change(function () {
            return $this.allCheckboxChange(this);
        });
